...
<section>
        ...
        <tbody>
          ...
          <tr @class(['text-sm', 'bg-gray-50' => $loop->odd])>
            ...
            <td>
              <div class="flex">
                <!-- 
                  web.php の /admin/blogs/{blog} の編集ページにデータを渡す
                -->
  ...
  <!-- 
    ✅ ページャー　
    → Laravelが paginate() の結果を見て、自動的にページネーション用のHTMLを生成する
  -->
  <!-- {{ $blogs->links() }} -->
  <!-- 
    現在のページの左右に2ページづつ表示する
  -->
