...
@section('content')
  ...
  <section id="access" class="mt-24 pb-24 bg-gray-100">
    ...
    <div class="flex mx-auto bg-white py-4 mt-10 md:w-192">
      ...
      <div class="mx-auto">
        <a href="/contact" class="inlfine-block text-xs text-white font-semibold leading-none rounded py-4 text-blue-700 border-solid bg-white border-blue-700 border-2 px-16 hover:text-white hover:bg-blue-700">お問い合わせ</a>
      </div>
    </div>
  </section>
@endsection